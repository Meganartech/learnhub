...
const StudentAttendanceByBatch = () => {
    const navigate = useNavigate();
const{batchId,batchName,StudentName,StudentId}=useParams();
    ...
    const fetchAttendance = async () => {
        ...
        try {
          const res = await axios.get(
            `${baseUrl}/view/MyAttendance/${batchId}stuId=${StudentId}&page=${currentPage}&size=${itemsperpage}`,
            {
              headers: {
                Authorization: token,
              },
...
export default StudentAttendanceByBatch