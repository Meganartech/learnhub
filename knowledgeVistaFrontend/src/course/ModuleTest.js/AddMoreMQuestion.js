...
const AddMoreMQuestion = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      formData.append(
        "answer",
        questionData.options[questionData.selectedOption]
      );
      ...
      const response = await axios.post(
        `${baseUrl}/Moduletest/addMoreQuestion/${mtestId}`,
        formData,
        {
          headers: {
            Authorization: token,
    ...
    <div>
                ...
                <div className="row align-items-center">
                    <div className="col-md-12">
                        <div className="page-header-title">
                            <h5 className="m-b-10">Add More Question</h5>
                        </div>
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item"><a href="#">Add More</a></li>
                        </ul>
      ...
      <div className="card">
        <div className="card-body">
          ...
          <h4>Add Question to {mtestName}</h4>
          ...
          <div className="row">
            <div className="col-12">
                ...
                {Object.keys(questionData.options).map((option, index) => (
                  <li className="choice" key={index}>
                    ...
                    <div>
                      <input
                        className={`form-control   ${
                          errors.options[option] && "is-invalid"
                        }`}
                        type="text"
              ...
              {errors.selectedOption && (
                <div className="invalid-feedback">{errors.selectedOption}</div>
              )}
                ...
                <div>
                  <button
                    ...
                    disabled={
                      ...
                      Object.values(questionData.options).some(
                        (option) => option.trim() === ""
                      )
                    }
                  >
...
export default AddMoreMQuestion;
