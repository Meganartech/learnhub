    ...
    return [
      {
        ...
        checked: todayIndex === 0,
      },
      {
        label: "Mon",
        value: "2",
        disabled: todayIndex === 1,
        checked: todayIndex === 1,
      },
      {
        label: "Tue",
        value: "3",
        disabled: todayIndex === 2,
        checked: todayIndex === 2,
      },
      {
        label: "Wed",
        value: "4",
        disabled: todayIndex === 3,
        checked: todayIndex === 3,
      },
      {
        label: "Thu",
        value: "5",
        disabled: todayIndex === 4,
        checked: todayIndex === 4,
      },
      {
        label: "Fri",
        value: "6",
        disabled: todayIndex === 5,
        checked: todayIndex === 5,
      },
      {
        label: "Sat",
        value: "7",
        disabled: todayIndex === 6,
        checked: todayIndex === 6,
      },
    ];
  });
  const getprefix = () => {
